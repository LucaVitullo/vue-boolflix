...
<main class="container-fluid">
    <div class="row flex-wrap text-light justify-content-evenly">
        ...
        <div class="col-2 fs-4 p-1 border border-2 m-2" v-for="item in films" :key="item.id">
            <img class="poster" :src="`http://image.tmdb.org/t/p/original${item.poster_path}`" alt="">
        ...
        <h1 class="bg-dark text-center p-2  border-light border-bottom">SERIE</h1>
